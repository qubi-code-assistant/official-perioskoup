    ...
    <div style={{ background: "#0A171E", minHeight: "100vh" }}>
      ...
      <section style={{ background: "#050C10", padding: "80px 0" }}>
        <div className="container">
          ...
          <div className="reveal-scale" style={{ borderRadius: 24, overflow: "hidden", border: "1px solid #234966", display: "grid", gridTemplateColumns: "1fr 1fr", maxWidth: 900 }}>
            {/* Photo */}
            <div style={{ position: "relative", minHeight: 360, overflow: "hidden" }}>
              <img src={AWARD_IMG} alt="EFP Digital Innovation Award 2025 ceremony" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center" }} />
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, transparent 60%, #1D3449)" }} />
            </div>
            {/* Content */}
            <div style={{ background: "#1D3449", padding: "48px 40px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 16 }}>
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
            ...
            <div className="reveal" style={{ transitionDelay: "0.08s" }}>
              <div style={{ background: "#1D3449", border: "1px solid #234966", borderRadius: 20, padding: 40 }}>
                {[
      ...
      <section style={{ background: "#050C10", padding: "120px 0" }}>
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20, maxWidth: 900, margin: "0 auto" }}>
            {[
              { img: ANCA_IMG, name: "Dr. Anca Laura Constantin", role: "Periodontist & CEO", creds: "DMD, PhD in Periodontology", bio: "Dr. Anca founded Perioskoup after recognizing that the biggest barrier to treatment success wasn't clinical skill — it was the communication gap between chair and home." },
